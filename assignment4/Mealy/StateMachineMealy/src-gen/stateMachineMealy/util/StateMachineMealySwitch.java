 ...
 * @generated
 */
public class StateMachineMealySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public StateMachineMealySwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case StateMachineMealyPackage.MEALY_STATE_MACHINE: {
			MealyStateMachine mealyStateMachine = (MealyStateMachine) theEObject;
			T result = caseMealyStateMachine(mealyStateMachine);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case StateMachineMealyPackage.TRANSATION: {
			Transation transation = (Transation) theEObject;
			T result = caseTransation(transation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mealy State Machine</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mealy State Machine</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMealyStateMachine(MealyStateMachine object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Transation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Transation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTransation(Transation object) {
		return null;
	}
